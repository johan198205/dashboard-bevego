...
import { TrendingUpIcon, UserIcon, SearchIcon } from "@/assets/icons";
...
export function NDIExcelScorecards({ data, loading }: NDIExcelScorecardsProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <Scorecard title="Riksbyggen byggt" icon={TrendingUpIcon}>
      ...
      <Scorecard title="Riksbyggen förvaltar" icon={UserIcon}>
      ...
      <Scorecard title="Hittade informationen" icon={SearchIcon}>
